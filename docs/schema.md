...
Root: This is an Arabic-specific mechanism. An Arabic word will usually be connected to other Arabic words through the root. This is many-to-many due to how intertwined roots are.
